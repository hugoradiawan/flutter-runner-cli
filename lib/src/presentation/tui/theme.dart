...
class FrunTheme {
  ...
  static FrunTheme dark() => FrunTheme(
    ...
    activeTabStyle: const Style(
      isBold: true,
    ).backgroundColor256(24).foregroundColor256(230),
    ...
    buttonStyle: const Style(
      isBold: true,
    ).backgroundColor256(28).foregroundColor256(255),
    buttonStopStyle: const Style(
      isBold: true,
    ).backgroundColor256(124).foregroundColor256(255),
    pickerChipStyle: const Style(
      isBold: true,
    ).backgroundColor256(22).foregroundColor256(231),
    pickerEmulatorChipStyle: const Style(
      isBold: true,
    ).backgroundColor256(25).foregroundColor256(231),
    pickerDeviceChipStyle: const Style(
      isBold: true,
    ).backgroundColor256(53).foregroundColor256(231),
    ...
    linkHighlightStyle: const Style(
      isBold: true,
    ).backgroundColor256(240).foregroundColor256(226),
    ...
    visualBlockStyle: const Style(
      isBold: true,
    ).backgroundColor256(63).foregroundColor256(231),
    ...
    cursorStyle: const Style().backgroundColor256(244).foregroundColor256(16),
  ...
  static FrunTheme light() => FrunTheme(
    ...
    pickerEmulatorChipStyle: const Style(
      isBold: true,
    ).backgroundColor256(24).foregroundColor256(231),
    pickerDeviceChipStyle: const Style(
      isBold: true,
    ).backgroundColor256(91).foregroundColor256(231),
    pickerChipSelectedStyle: const Style(
      isBold: true,
    ).backgroundColor256(34).foregroundColor256(255),
    pickerEmulatorChipSelectedStyle: const Style(
